...
//    }
    ...
    public static ScannerService makeScannerService
            (@NonNull WifiManager wifiManager, @NonNull Handler handler, @NonNull Settings settings,@NonNull Context context) {
        return new Scanner(wifiManager, handler, settings,context);
    }
}
