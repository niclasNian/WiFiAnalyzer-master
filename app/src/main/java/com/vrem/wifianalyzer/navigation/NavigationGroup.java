...
public enum NavigationGroup {
    ...
    GROUP_OTHER(NavigationMenu.EXPORT, NavigationMenu.CHANNEL_AVAILABLE,NavigationMenu.SNIFFER, NavigationMenu.VENDOR_LIST,NavigationMenu.FORGERY,NavigationMenu.WIFI_HOTSPOT),
