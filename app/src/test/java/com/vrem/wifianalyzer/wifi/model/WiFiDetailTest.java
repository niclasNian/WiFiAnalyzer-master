...
public class WiFiDetailTest {
    ...
    public void testGetTitleWithEmptySSID() throws Exception {
        ...
        fixture = new WiFiDetail(StringUtils.EMPTY, BSSID, WPA, wiFiSignal, client, cipher);
        // validate
        assertEquals(expectedTitle, fixture.getTitle());
    }
    ...
    public void testEquals() throws Exception {
        // setup
        WiFiDetail other = new WiFiDetail(SSID, BSSID, WPA, wiFiSignal, client, cipher);
        // execute & validate
    ...
    public void testWiFiDetailCopyConstructor() throws Exception {
        // setup
        WiFiDetail expected = new WiFiDetail(StringUtils.EMPTY, BSSID, WPA, wiFiSignal, client, cipher);
        // execute
